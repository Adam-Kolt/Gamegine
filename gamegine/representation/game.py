...
class Game(object):
    ...
    def __recompute_field_border_obstacles(self) -> 'Game':
        ...
        self.modify_obstacles([
            obstacle.Rectangular("Field Border Top", Zero(), Zero() - thickness, self.field_size[0], thickness).invisible(),
            obstacle.Rectangular("Field Border Bottom", Zero(), self.field_size[1], self.field_size[0], thickness).invisible(),
            obstacle.Rectangular("Field Border Left", Zero() - thickness, Zero(), thickness, self.field_size[1]).invisible(),
            obstacle.Rectangular("Field Border Right", self.field_size[0], Zero(), thickness, self.field_size[1]).invisible()
        ])
