---
title: gamegine.utils.NCIM.Dimensions.energy
---
...
```python
def __init__(self, magnitude: float, unit: gamegine.utils.NCIM.Dimensions.energy.EnergyUnit, base_magnitude=None) -> None
```
