---
title: gamegine.utils.NCIM.Dimensions.current
---
...
```python
def __init__(self, magnitude: float, unit: gamegine.utils.NCIM.Dimensions.current.CurrentUnit, base_magnitude=None) -> None
```
